            ...
            <div className="header__nav">
                ...
                <Link to={!user && "/login"} className="header__link">
                    <div onClick={logoutUser} className="header__option">
                        <span className="header__optionLine1">Bonjour, {loggedinuser?.email}</span>
                        <span className="header__optionLine2">{loggedinuser ? 'Déconnectez-vous' : 'Connectez-vous'}</span>
                    </div>
                </Link>
